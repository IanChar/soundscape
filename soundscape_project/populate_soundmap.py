...
def populate():
	...
	add_song(name="Strawberry Fields", artist = "The Beatles", url="", lat=53.41, lng=-2.983)
	add_song(name="Money", artist = "Pink Floyd", url="", lat=51.51, lng=-0.14)
	add_song(name="Sheep", artist = "Pink Floyd", url="", lat=52, lng=1)
	...
	add_song(name="Who Are You", artist = "The Who", url="", lat=53.566, lng=-2.395)
